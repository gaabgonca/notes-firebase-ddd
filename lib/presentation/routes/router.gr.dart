  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    NoteFormPageRoute.name: (routeData) => _i1.MaterialPageX<dynamic>(
        ...
        builder: (data) {
          ...
          return _i6.NoteFormPage(key: args.key, editingNote: args.editingNote);
        },
...
class NoteFormPageRoute extends _i1.PageRouteInfo<NoteFormPageRouteArgs> {
  NoteFormPageRoute({_i2.Key? key, required _i7.Note? editingNote})
      : super(name,
            path: '/note-form-page',
            args: NoteFormPageRouteArgs(key: key, editingNote: editingNote));

  static const String name = 'NoteFormPageRoute';
}

class NoteFormPageRouteArgs {
  const NoteFormPageRouteArgs({this.key, required this.editingNote});

  final _i2.Key? key;

  final _i7.Note? editingNote;
}
